...
const licenses = [
  { name: 'MIT_License', value: 'MIT', url: 'https://opensource.org/licenses/MIT', badge: 'MIT'},
  { name: 'BSD_2-Clause_"Simplified"_License', value: 'BSD-2-Clause', url: 'https://opensource.org/licenses/BSD-2-Clause', badge: 'BSD--2--Clause'},
  { name: 'BSD 3-Clause_"New"_or_"Revised"_License', value: 'BSD-3-Clause', url: 'https://opensource.org/licenses/BSD-3-Clause', badge: 'BSD--3--Clause'},
  { name: 'GNU_GPLv3', value: 'GPL-3.0', url: 'https://www.gnu.org/licenses/gpl-3.0.en.html', badge: 'GPL--3.0'},
  { name: 'Mozilla_Public_License 2.0', value: 'MPL-2.0', url: 'https://opensource.org/licenses/MPL-2.0', badge: 'MPL--2.0'},
  { name: 'The_Unlicense', value: 'unlicense', url: 'http://unlicense.org/', badge: 'unlicense'},
  { name: 'Apache_License_2.0', value: 'Apache-2.0', url: 'https://opensource.org/licenses/Apache-2.0', badge:'Apache--2.0'},
];
